                        ...
                        <div class="grid md:grid-cols-5 gap-0">
                            ...
                            <div
                                ...
                                <div class="absolute top-6 left-6">
                                    <div class="flex items-center rounded-full bg-green-500 px-4 py-2 shadow-lg">
                                        <div class="mr-2 h-2.5 w-2.5 rounded-full bg-white animate-pulse"></div>
                                            ...
                                            <div class="flex items-start">
                                                ...
                                                <div class="text-sm text-gray-700">
                                                    <p class="font-semibold">
                                                        {{ $worker->user->userData->country ?? 'O\'zbekiston' }}</p>
                                                    @if ($worker->user->userData->region)
                                                        <p class="text-gray-600">{{ $worker->user->userData->region }}
                                                        </p>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-6 mb-8">
                                        ...
                                        @if ($worker->user->userData->gender)
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    <p class="text-xs text-gray-500 uppercase tracking-wide">Jins</p>
                                        ...
                                        @if ($worker->user->userData->birthday)
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    <p class="text-xs text-gray-500 uppercase tracking-wide">Yosh</p>
                                                    <p class="text-sm font-semibold text-gray-900">
                                        ...
                                        @if ($worker->user->userData->height)
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    <p class="text-xs text-gray-500 uppercase tracking-wide">Bo'y</p>
                                                    <p class="text-sm font-semibold text-gray-900">
                                        ...
                                        @if ($worker->user->userData->weight)
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    <p class="text-xs text-gray-500 uppercase tracking-wide">Vazn</p>
                                                    <p class="text-sm font-semibold text-gray-900">
                                            ...
                                            <div class="space-y-2 text-gray-700">
                                                @if ($worker->user->userData->country)
                                                    <p class="flex items-center">
                                                        <span class="w-24 text-sm text-gray-500">Mamlakat:</span>
                                                        <span
                                                ...
                                                @if ($worker->user->userData->province)
                                                    <p class="flex items-center">
                                                        <span class="w-24 text-sm text-gray-500">Viloyat:</span>
                                                        <span
                                                ...
                                                @if ($worker->user->userData->region)
                                                    <p class="flex items-center">
                                                        <span class="w-24 text-sm text-gray-500">Tuman:</span>
                                                        <span
                                                ...
                                                @if ($worker->user->userData->address)
                                                    <p class="flex items-center">
                                                        <span class="w-24 text-sm text-gray-500">Ko'cha:</span>
                                                        <span
