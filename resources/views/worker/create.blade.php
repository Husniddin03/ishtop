    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row items-center justify-between bg-white shadow-md rounded-lg p-4 gap-4">
            <h2 class="text-2xl font-bold text-gray-900 tracking-wide">
                {{ __('O\'z malumotlaringizni kiriting') }}
            </h2>
                ...
                <div class="p-6">
                    <form action="{{ route('workers.store') }}" method="POST" class="space-y-6"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Familiya -->
                            <div>
                                <label for="last_name" class="block text-sm font-medium text-gray-700">Familiya
                                    *</label>
                            ...
                            <div class="md:col-span-2">
                                <h3 class="text-lg font-medium text-gray-900 mb-4 border-b pb-2">📞 Aloqa ma'lumotlari
                                </h3>
                            </div>
