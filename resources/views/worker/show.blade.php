    ...
    <x-slot name="header">
        <div
            ...
            <div class="flex-1">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                <svg class="w-4 h-4 text-gray-400 mx-1" aria-hidden="true" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="m1 9 4-4-4-4" />
                                </svg>
                                <a href="{{ route('workers.index') }}"
                                    class="ms-1 text-sm font-medium text-gray-500 hover:text-indigo-600 transition-colors">
                                    Ishchilar
                                </a>
                            </div>
                        </li>
                ...
                <h2
                    class="text-2xl md:text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                    {{ __('Ishchi profili') }}
                </h2>
            </div>
                    ...
                    <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                ...
                                <span class="text-sm font-medium text-gray-900">{{ $worker->user->userData->views_count ?? 0 }}</span>
                            </div>
                        </div>
                    </div>
