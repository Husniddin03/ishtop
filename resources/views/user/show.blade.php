                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-900 truncate max-w-xs">
                                    @if ($user->userData)
                    ...
                    <div class="relative px-6 md:px-10 pb-10 pt-24">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:items-end gap-8">
                                        ...
                                        @else
                                            <div
                                                ...
                                                <span class="text-5xl font-bold text-white">
                                                    @if ($user->userData)
                                                        {{ substr($user->userData->first_name, 0, 1) }}{{ substr($user->userData->last_name, 0, 1) }}
                                                    @else
                                ...
                                <div class="flex-1 text-center md:text-left">
                                    ...
                                    <div class="flex flex-wrap justify-center md:justify-start gap-3 mb-6">
                                        <span
                                            ...
                                            {{ $user->userData->region }}, {{ $user->userData->district }}
                                        </span>
                                        ...
                                        <div class="flex items-center justify-center md:justify-start space-x-1">
                                            @for ($i = 1; $i <= 5; $i++)
                                                @if ($i <= floor($worker->rating))
                                                    <svg class="w-6 h-6 text-yellow-400 fill-current"
                                                        viewBox="0 0 20 20">
                                                        <path
                            ...
                            @if ($user->userContact)
                                <!-- Contact Button -->
                                <div class="pb-4">
                                    <a href="tel:{{ $user->userContact->phone }}"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <span class="text-sm font-medium text-gray-500 bg-gray-100 px-3 py-1 rounded-full">
                                    {{ Str::length($user->userData->bio ?? '') }} belgi
                                </span>
                            </div>
                        ...
                        <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <!-- Telegram -->
                                @if ($user->userContact->telegram)
                                    <a href="https://t.me/{{ ltrim($user->userContact->telegram, '@') }}"
                                        target="_blank"
                                        ...
                                        <div class="relative flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="text-sm opacity-90">{{ $user->userContact->telegram }}</span>
                                            </div>
                                        </div>
                                ...
                                <!-- Instagram -->
                                @if ($user->userContact->instagram)
                                    <a href="https://instagram.com/{{ ltrim($user->userContact->instagram, '@') }}"
                                        target="_blank"
                                        ...
                                        <div class="relative flex items-center space-x-4">
                                            <div
                                                ...
                                                <svg class="w-8 h-8" fill="none" stroke="currentColor"
                                                    ...
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2" d="M17.5 6.5h.01" />
                                                </svg>
                                            </div>
                                            <div>
                                                <span class="text-lg font-bold block">Instagram</span>
                                                <span
                                                    class="text-sm opacity-90">{{ $user->userContact->instagram }}</span>
                                            </div>
                                        </div>
                                        <svg class="w-5 h-5 opacity-50 group-hover:translate-x-1 transition-transform"
                                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- Facebook -->
                                @if ($user->userContact->facebook)
                                    <a href="https://facebook.com/{{ ltrim($user->userContact->facebook, '@') }}"
                                        target="_blank"
                                        ...
                                        <div class="relative flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="text-sm opacity-90">{{ $user->userContact->facebook }}</span>
                                            </div>
                                        </div>
                                        <svg class="w-5 h-5 opacity-50 group-hover:translate-x-1 transition-transform"
                                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                            ...
                            <div
                                class="p-6 bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl border border-gray-100">
                                    ...
                                    <div class="flex-1">
                                        <div class="space-y-2">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <span
                                                    class="text-lg font-bold text-gray-900">{{ $user->userData->region }}</span>
                                            </div>
                                            <div class="flex items-center space-x-2">
                                                <span class="text-sm font-medium text-gray-500">Tuman:</span>
                                                <span
                                                    class="text-lg font-bold text-gray-900">{{ $user->userData->district }}</span>
                                            </div>
                                            @if ($user->userData->village)
                                                <div class="flex items-center space-x-2">
                                                    <span class="text-sm font-medium text-gray-500">Mahalla:</span>
                                                    <span
                                                        class="text-lg font-medium text-gray-800">{{ $user->userData->village }}</span>
                                                </div>
                                            @endif
                                            @if ($user->userData->address)
                                                <div class="flex items-center space-x-2 mt-3">
                                                    <span class="text-sm font-medium text-gray-500">To'liq
                                                        manzil:</span>
                                                    <span
                                                        class="text-lg font-medium text-gray-800">{{ $user->userData->address }}</span>
                                                </div>
                                            @endif
                                        </div>

                                        @if ($user->userData->latitude && $user->userData->longitude)
                                            <a href="https://www.google.com/maps?q={{ $user->userData->latitude }},{{ $user->userData->longitude }}"
                                                target="_blank"
                    ...
                    <div class="space-y-8">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-lg font-bold text-gray-900">
                                                {{ $user->userData->birthday ? \Carbon\Carbon::parse($user->userData->birthday)->age . ' yosh' : '—' }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="text-xs font-medium px-3 py-1 bg-blue-100 text-blue-700 rounded-full">
                                        {{ $user->userData->birthday ? \Carbon\Carbon::parse($user->userData->birthday)->format('d.m.Y') : '—' }}
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-lg font-bold text-gray-900">
                                                {{ $user->userData->gender === 'male' ? 'Erkak' : 'Ayol' }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="relative rounded-3xl shadow-2xl overflow-hidden">
                            <!-- Background Gradient -->
                            <div
                                class="absolute inset-0 bg-gradient-to-br from-indigo-900 via-purple-900 to-violet-900">
                            </div>
                            ...
                            <div class="relative p-8 text-white">
                                <div class="mb-6">
                                    <span
                                        class="text-xs font-bold uppercase tracking-wider text-indigo-300 opacity-70">
                            ...
                            <div class="space-y-4">
                                ...
                                @if ($worker->experience)
                                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                        ...
                                        <span class="text-lg font-bold text-gray-900">{{ $worker->experience }}
                                            yil</span>
                                    </div>
                                @endif
                                ...
                                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                    ...
                                    <span
                                        class="text-sm font-medium text-gray-900">{{ $user->userData->views_count ?? 0 }}</span>
                                </div>
                            </div>
                        </div>
