<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row items-center justify-between bg-white shadow-sm rounded-xl p-4 md:p-6 gap-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('works.index') }}" class="ms-1 text-sm font-medium text-gray-500 hover:text-indigo-600">Ishlar</a>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ms-1 text-sm font-medium text-gray-900">{{ Str::limit($work->name, 30) }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('works.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-all duration-200 shadow-sm hover:shadow">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                    </svg>
                    Orqaga
                </a>
                <button class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        ...
                        @else
                        <div class="aspect-w-16 aspect-h-9 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center rounded-2xl">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 pb-8 border-b border-gray-100">
                            <div>
                                @if($work->price)
                                <div class="mb-2">
                                    <span class="text-4xl font-bold text-gray-900">{{ number_format($work->price, 0, '.', ' ') }}</span>
                            ...
                            <div class="mt-4 md:mt-0">
                                <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 border border-indigo-200">
                                    {{ $work->type }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="prose max-w-none">
                                <p class="text-gray-700 leading-relaxed whitespace-pre-line bg-gray-50 rounded-xl p-6">{{ $work->description }}</p>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="flex items-center p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                                    <div class="flex-shrink-0 w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm border border-blue-200">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-lg font-bold text-gray-900">{{ $work->how_much_people }} kishi</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-100">
                                    <div class="flex-shrink-0 w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm border border-purple-200">
                                        @if($work->gender === 'male')
                                ...
                                <div class="flex items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100">
                                    <div class="flex-shrink-0 w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm border border-green-200">
                                ...
                                <!-- Lunch -->
                                <div class="flex items-center p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-100">
                                    <div class="flex-shrink-0 w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm border border-orange-200">
                                        @if($work->lunch)
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-lg font-bold {{ $work->lunch ? 'text-green-600' : 'text-gray-600' }}">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <!-- Start Date -->
                                <div class="text-center p-6 bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl border border-indigo-100">
                                    <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm border border-indigo-200">
                                ...
                                <div class="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-100">
                                    <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm border border-purple-200">
                                    ...
                                    <p class="text-lg font-bold text-gray-900">
                                        {{ \Carbon\Carbon::parse($work->start_time)->format('H:i') }} - {{ \Carbon\Carbon::parse($work->finish_time)->format('H:i') }}
                                    </p>
                                </div>

                                <!-- Duration -->
                                <div class="text-center p-6 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl border border-emerald-100">
                                    <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm border border-emerald-200">
                ...
                <div class="space-y-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <a href="tel:{{ $work->user->userContact->phone }}" 
                               class="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 hover:border-green-300 transition-all duration-200 group">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-sm border border-green-200 group-hover:border-green-300">
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                ...
                                <a href="{{ $work->user->userContact->telegram }}" target="_blank" 
                                   class="flex flex-col items-center justify-center p-3 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl border border-blue-200 hover:border-blue-300 transition-all duration-200 group">
                                    <div class="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-sm border border-blue-200 group-hover:border-blue-300 mb-2">
                                ...
                                <a href="{{ $work->user->userContact->instagram }}" target="_blank" 
                                   class="flex flex-col items-center justify-center p-3 bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl border border-pink-200 hover:border-pink-300 transition-all duration-200 group">
                                    <div class="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-sm border border-pink-200 group-hover:border-pink-300 mb-2">
                                        <span class="text-xl">📸</span>
                                    </div>
                            ...
                            <!-- Send Message Button -->
                            <button class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-md hover:shadow-lg mt-4">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="p-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl border border-gray-200">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        @if($work->region)<p class="text-gray-700">{{ $work->region }}</p>@endif
                                        @if($work->district)<p class="text-gray-700">{{ $work->district }}</p>@endif
                                        @if($work->village)<p class="text-gray-700">{{ $work->village }}</p>@endif
                                        @if($work->address)<p class="mt-2 text-gray-900 font-medium">{{ $work->address }}</p>@endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-sm border border-blue-200">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-sm font-medium text-gray-900">{{ $work->created_at->format('d.m.Y H:i') }}</span>
                                </div>
                                <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                    <span class="text-sm font-medium text-gray-600">Yangilangan:</span>
                                    <span class="text-sm font-medium text-gray-900">{{ $work->updated_at->diffForHumans() }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Apply Button -->
                    <button class="w-full py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold text-lg rounded-2xl hover:from-green-600 hover:to-emerald-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                        Ishga ariza berish
                    </button>
